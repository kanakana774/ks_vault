### **【社内研修資料】データベース設計入門：なぜテーブルを分けて管理するのか？**
...
<font color="blue">顧客に関する情報だけ</font>をまとめます。
...
**② 商品テーブル (products_mst)**
<font color="green">商品に関する情報だけ</font>をまとめます。
...
**③ 注文テーブル (orders_trn)**
<font color="red">「いつ」「誰が」注文したか</font>という情報だけをまとめます。
...
<font color="orange">「どの注文で」「どの商品を」「いくつ」買ったか</font>という情報だけをまとめます。
