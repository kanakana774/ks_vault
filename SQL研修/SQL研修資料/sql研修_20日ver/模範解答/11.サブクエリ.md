...
## 問 5：「支払い金額が全体のトップ 3 に入る注文 ID と金額」を取得してください。
...
また分割払いを考慮するとさらに group by が必要になる

## 問 6：「最も多く売れた商品（数量ベース）の商品名と販売数量合計」を取得してください。
...
## 問 7：各顧客が「最も高額な注文」で支払った金額を取得してください。
...
- クエリが見やすい。
- 実務でレビューが通りやすく、パフォーマンスも安定。
- 推奨されやすい解法。

## 問 8：平均より高い価格の商品だけを購入したことがある顧客の名前を取得してください
