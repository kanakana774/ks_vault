...
> 📖 ハッシュテーブルの作り方、`Buckets` の意味、なぜ Hash Join が等価結合専用なのか、`Buffers` が両テーブルのページ数の「和」になる理由 ── アルゴリズムの中身は [[17-3_補足_結合アルゴリズム|17-3_補足_結合アルゴリズム]] にまとめています。
...
なお、結合方式（Nested Loop / Hash / Merge）の中身が気になった人は [[17-3_補足_結合アルゴリズム|補足：結合アルゴリズム]] へどうぞ。
